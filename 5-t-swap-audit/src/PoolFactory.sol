...
contract PoolFactory {
    ...
    /*//////////////////////////////////////////////////////////////
                            STATE VARIABLES
    //////////////////////////////////////////////////////////////*/
    mapping(address token => address pool) private s_pools; // audit-e poolToken -> pool?
    mapping(address pool => address token) private s_tokens; // audit-e mapping back
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // audit-e tokenAddress -> weth for a token/weth pool
    function createPool(address tokenAddress) external returns (address) {
        if (s_pools[tokenAddress] != address(0)) {
            revert PoolFactory__PoolAlreadyExists(tokenAddress);
        }
        // audit-q "T-Swap Dai" but what if ERC20 method reverts? name()
        string memory liquidityTokenName = string.concat(
            "T-Swap ",
            IERC20(tokenAddress).name()
        );
        // audit-info "tsUSDC" -> should be .symbol()
